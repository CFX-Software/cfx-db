...
function Relations.query(table, params, callback)
    ...
    exports[cfxDbResource]:query('functions/relations:queryWithRelations', args, callback)
end
...
function Relations.queryAsync(table, params)
    ...
    local success, result = pcall(function()
        return exports[cfxDbResource]:queryAsync('functions/relations:queryWithRelations', args)
    end)
...
function Relations.count(table, params, callback)
    ...
    exports[cfxDbResource]:query('functions/relations:countWithRelations', args, callback)
end
