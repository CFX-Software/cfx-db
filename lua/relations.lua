...
function Relations.query(table, params, callback)
    ...
    exports['cfx-db']:query('relations.queryWithRelations', args, callback)
end
...
function Relations.queryAsync(table, params)
    ...
    local success, result = exports['cfx-db']:queryAsync('relations.queryWithRelations', args)
...
function Relations.count(table, params, callback)
    ...
    exports['cfx-db']:query('relations.countWithRelations', args, callback)
end
