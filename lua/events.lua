...
function Events.on(event, callback)
    ...
    exports[cfxDbResource]:subscribeToEvent(event, callback)
...
function Events.off(event, callback)
    ...
    exports[cfxDbResource]:unsubscribeFromEvent(event, callback)
...
function Events.emit(eventData)
    ...
    log.warn("DBEvents.emit is deprecated; events are emitted automatically")
end
