...
function Audit.query(filters, callback)
    ...
    exports[cfxDbResource]:query('audit.queryLogs', filters, callback)
end
...
function Audit.byTable(tableName, limit, callback)
    ...
    exports[cfxDbResource]:query('audit.queryByTable', {
        table = tableName,
        limit = limit
    }, callback)
end
...
function Audit.byResource(resourceName, limit, callback)
    ...
    exports[cfxDbResource]:query('audit.queryByResource', {
...
function Audit.byPlayer(playerId, limit, callback)
    ...
    exports[cfxDbResource]:query('audit.queryByPlayer', {
        playerId = playerId,
        limit = limit
    }, callback)
end
...
function Audit.byOperation(operation, limit, callback)
    ...
    exports[cfxDbResource]:query('audit.queryByOperation', {
        operation = operation,
        limit = limit
    }, callback)
end
...
function Audit.recent(limit, callback)
    ...
    exports[cfxDbResource]:query('audit.getRecentLogs', {
        limit = limit
    }, callback)
end
...
function Audit.failed(limit, callback)
    ...
    exports[cfxDbResource]:query('audit.getFailedOperations', {
        limit = limit
    }, callback)
end
...
function Audit.stats(startTime, endTime, callback)
    ...
    exports[cfxDbResource]:query('audit.getStatistics', {
        startTime = startTime,
        endTime = endTime
    }, callback)
end
