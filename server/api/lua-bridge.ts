/**
 * Lua Bridge - Lua-compatible wrappers for the API
 *
...
/**
 * Lua-compatible query with callback
 */
export async function luaQuery(
    ...
    try {
        ...
        const cacheKey = args && args.table && args.operation
            ? QueryCache.generateKey(args.operation, args.table, args)
            : null;
        ...
        const result = await query(queryName as any, args);
